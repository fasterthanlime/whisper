//! Metal-accelerated BERT (Bidirectional Encoder Representations from Transformers)
//!
//! This is a vendored copy of candle-transformers BERT with Metal-accelerated `LayerNorm`.
//! Enables full GPU acceleration for embedding models on Apple Silicon.
//!
//! Based on candle-transformers 0.9.1
...
// Suppress pedantic warnings for vendored code to maintain compatibility with upstream candle-transformers
#![allow(
    dead_code,
...
#[derive(Clone)]
struct Dropout {
    #[allow(dead_code)] // Field kept for API compatibility with vendored candle-transformers BERT
    pr: f64,
}
