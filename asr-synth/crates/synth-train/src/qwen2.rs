//! Quantized Qwen2 model implementation, vendored from candle-transformers 0.9.2
//! with `clear_kv_cache` added.
//!
//! Original: candle-transformers/src/models/quantized_qwen2.rs
