...
export interface SessionAmbiguitySummary {
  pending_token_count: number;
  low_concentration_count: number;
  low_margin_count: number;
  volatile_token_count: number;
...
export interface TranscribeZipaPhoneSpan {
  token_id: number;
  token: string;
  start_frame: number;
  end_frame: number;
...
export interface TranscribeAsrTokenAlternative {
  token_id: number;
  text: string;
  logit: number;
}

export interface TranscribeAsrObservedToken {
  token_index: number;
  chosen_text: string;
  concentration: number;
  margin: number;
  revision: bigint;
  alternatives: TranscribeAsrTokenAlternative[];
}

export interface TranscribePhoneticWordAlignment {
  word_text: string;
  token_start: number;
  token_end: number;
  start_sec: number;
  end_sec: number;
  zipa_raw_phone_start: number | null;
  zipa_raw_phone_end: number | null;
  zipa_start_sec: number | null;
  zipa_end_sec: number | null;
...
export type TranscribePhoneticAnchorConfidence =
  | { tag: 'Low' }
  | { tag: 'Medium' }
  | { tag: 'High' };

export type TranscribePhoneticSpanUsefulness =
  | { tag: 'Low' }
  | { tag: 'Medium' }
  | { tag: 'High' };

export type TranscribePhoneticSpanClass =
  | { tag: 'Repeat' }
  | { tag: 'ShortCodeTerm' }
  | { tag: 'VowelHeavy' }
  | { tag: 'ProperNoun' }
...
export interface TranscribePhoneticSpan {
  ...
  zipa_normalized: string[];
  transcript_normalized: string[];
  transcript_phone_count: number;
  chosen_zipa_phone_count: number;
  transcript_similarity: number | null;
  transcript_feature_similarity: number | null;
  projected_alignment_score: number | null;
  chosen_alignment_score: number | null;
  second_best_alignment_score: number | null;
  alignment_score_gap: number | null;
  alignment_source: string;
  anchor_confidence: TranscribePhoneticAnchorConfidence;
  span_usefulness: TranscribePhoneticSpanUsefulness;
  span_class: TranscribePhoneticSpanClass;
  zipa_rescue_eligible: boolean;
  alignment: TranscribePhoneticAlignmentOp[];
...
export interface TranscribePhoneticTrace {
  ...
  session_audio_f32: number[];
  session_audio_sample_rate_hz: number;
  tail_ambiguity: SessionAmbiguitySummary;
  worst_raw_span_index: number | null;
  worst_contentful_span_index: number | null;
  best_rescue_span_index: number | null;
  utterance_zipa_raw: string[];
  utterance_zipa_phone_spans: TranscribeZipaPhoneSpan[];
  ...
  asr_alternatives: TranscribeAsrObservedToken[];
  word_alignments: TranscribePhoneticWordAlignment[];
...
export type RotationCutStrategy =
  ...
  | { tag: 'Qwen3' }
  | { tag: 'Zipa' }
  | { tag: 'ManualTargetCommittedTextTokens'; value: number };
...
export interface SessionSnapshot {
  ...
  pending_text: string;
  full_text: string;
  committed_token_count: number;
  pending_token_count: number;
  committed_words: AlignedWord[];
  pending_tokens: PendingToken[];
  ambiguity: SessionAmbiguitySummary;
...
export interface SynthesizePhonemesRequest {
  phonemes: string;
  voice: string | null;
  speed: number | null;
}

export interface SynthesizePhonemesResult {
  wav_bytes: Uint8Array;
  sample_rate_hz: number;
  resolved_voice: string;
}

export interface LoadAudioFileRequest {
  path: string;
}

export interface LoadAudioFileResult {
  wav_bytes: Uint8Array;
}
...
export type CorpusAlignmentSelectedSpanRole =
  | { tag: 'BestRescue' }
  | { tag: 'WorstContentful' }
  | { tag: 'WorstRaw' };
...
export interface CorpusAlignmentEvalRow {
  ...
  utterance_similarity: number | null;
  utterance_feature_similarity: number | null;
  tail_volatile_token_count: number;
  row_rescue_ready: boolean;
  positive_span_count: number;
  contentful_span_count: number;
  rescue_eligible_span_count: number;
  worst_span_feature_similarity: number | null;
  best_span_delta: number | null;
  selected_span_role: CorpusAlignmentSelectedSpanRole | null;
  selected_span_text: string | null;
  selected_span_feature_similarity: number | null;
  selected_span_best_delta: number | null;
...
export type SynthesizePhonemesResponse = { ok: true; value: SynthesizePhonemesResult } | { ok: false; error: string };

export type LoadAudioFileResponse = { ok: true; value: LoadAudioFileResult } | { ok: false; error: string };
...
export interface BeeMlCaller {
  ...
  synthesizePhonemes(request: SynthesizePhonemesRequest): Promise<{ ok: true; value: SynthesizePhonemesResult } | { ok: false; error: string }>;
  loadAudioFile(request: LoadAudioFileRequest): Promise<{ ok: true; value: LoadAudioFileResult } | { ok: false; error: string }>;
...
export class BeeMlClient implements BeeMlCaller {
  ...
  /** Stream audio chunks (16kHz mono f32) and receive incremental transcription updates. */
  async streamTranscribe(audioIn: Rx<number[]>, updatesOut: Tx<SessionSnapshot>): Promise<{ ok: true; value: void } | { ok: false; error: string }> {
  ...
  async synthesizePhonemes(request: SynthesizePhonemesRequest): Promise<{ ok: true; value: SynthesizePhonemesResult } | { ok: false; error: string }> {
    const descriptor = beeMl_synthesizePhonemes_method;
    const sendSchemas = beeMl_descriptor.send_schemas;
      try {
        const value = await this.caller.call({
          method: "BeeMl.synthesizePhonemes",
          args: { request },
          descriptor,
          sendSchemas,
        });
        return { ok: true, value } as { ok: true; value: SynthesizePhonemesResult } | { ok: false; error: string };
      } catch (e: any) {
        if (e instanceof RpcError && e.isUserError()) {
          return { ok: false, error: e.userError } as { ok: true; value: SynthesizePhonemesResult } | { ok: false; error: string };
        }
        throw e;
      }
  }

  async loadAudioFile(request: LoadAudioFileRequest): Promise<{ ok: true; value: LoadAudioFileResult } | { ok: false; error: string }> {
    const descriptor = beeMl_loadAudioFile_method;
    const sendSchemas = beeMl_descriptor.send_schemas;
      try {
        const value = await this.caller.call({
          method: "BeeMl.loadAudioFile",
          args: { request },
          descriptor,
          sendSchemas,
        });
        return { ok: true, value } as { ok: true; value: LoadAudioFileResult } | { ok: false; error: string };
      } catch (e: any) {
        if (e instanceof RpcError && e.isUserError()) {
          return { ok: false, error: e.userError } as { ok: true; value: LoadAudioFileResult } | { ok: false; error: string };
        }
        throw e;
      }
  }
...
export interface BeeMlHandler {
  ...
  synthesizePhonemes(request: SynthesizePhonemesRequest): Promise<{ ok: true; value: SynthesizePhonemesResult } | { ok: false; error: string }> | { ok: true; value: SynthesizePhonemesResult } | { ok: false; error: string };
  loadAudioFile(request: LoadAudioFileRequest): Promise<{ ok: true; value: LoadAudioFileResult } | { ok: false; error: string }> | { ok: true; value: LoadAudioFileResult } | { ok: false; error: string };
...
export class BeeMlDispatcher implements Dispatcher {
  ...
  async dispatch(_context: RequestContext, method: MethodDescriptor, args: unknown[], call: VoxCall): Promise<void> {
    if (method.id === 0x5769301e350ea60bn) {
      ...
      try {
        const result = await this.handler.streamTranscribe(args[0] as Rx<number[]>, args[1] as Tx<SessionSnapshot>);
    ...
    } else if (method.id === 0xab5123646f0c3f79n) {
      try {
        const result = await this.handler.synthesizePhonemes(args[0] as SynthesizePhonemesRequest);
        if (result.ok) call.reply(result.value); else call.replyErr(result.error);
      } catch (error) {
        call.replyInternalError(error instanceof Error ? error.message : String(error));
      }
    } else if (method.id === 0x8d084b52cc27c60cn) {
      try {
        const result = await this.handler.loadAudioFile(args[0] as LoadAudioFileRequest);
        if (result.ok) call.reply(result.value); else call.replyErr(result.error);
      } catch (error) {
        call.replyInternalError(error instanceof Error ? error.message : String(error));
      }
...
export const beeMl_send_schemas: import("@bearcove/vox-core").ServiceSendSchemas = {
  schemas: new Map<bigint, import("@bearcove/vox-postcard").Schema>([
    ...
    [0x1ab1256ee5bb2ecen, { id: 0x1ab1256ee5bb2ecen, type_params: [], kind: { tag: 'struct', name: 'SessionAmbiguitySummary', fields: [{ name: 'pending_token_count', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'low_concentration_count', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'low_margin_count', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'volatile_token_count', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'mean_concentration', type_ref: { tag: 'concrete', type_id: 0x8e02f623d1b2310cn, args: [] }, required: true }, { name: 'mean_margin', type_ref: { tag: 'concrete', type_id: 0x8e02f623d1b2310cn, args: [] }, required: true }, { name: 'min_concentration', type_ref: { tag: 'concrete', type_id: 0x8e02f623d1b2310cn, args: [] }, required: true }, { name: 'min_margin', type_ref: { tag: 'concrete', type_id: 0x8e02f623d1b2310cn, args: [] }, required: true }] } }],
    [0xdcafd4de6b7969bbn, { id: 0xdcafd4de6b7969bbn, type_params: ['T'], kind: { tag: 'option', element: { tag: 'var', name: 'T' } } }],
    [0x23fcc4d252bc76fbn, { id: 0x23fcc4d252bc76fbn, type_params: [], kind: { tag: 'struct', name: 'TranscribeZipaPhoneSpan', fields: [{ name: 'token_id', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'token', type_ref: { tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }, required: true }, { name: 'start_frame', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'end_frame', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'start_sec', type_ref: { tag: 'concrete', type_id: 0x3f2e589db81e95bfn, args: [] }, required: true }, { name: 'end_sec', type_ref: { tag: 'concrete', type_id: 0x3f2e589db81e95bfn, args: [] }, required: true }] } }],
    ...
    [0x2cdd83694d7a0528n, { id: 0x2cdd83694d7a0528n, type_params: [], kind: { tag: 'struct', name: 'TranscribeAsrTokenAlternative', fields: [{ name: 'token_id', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'text', type_ref: { tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }, required: true }, { name: 'logit', type_ref: { tag: 'concrete', type_id: 0x8e02f623d1b2310cn, args: [] }, required: true }] } }],
    [0x02c0774b24ecc733n, { id: 0x02c0774b24ecc733n, type_params: [], kind: { tag: 'struct', name: 'TranscribeAsrObservedToken', fields: [{ name: 'token_index', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'chosen_text', type_ref: { tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }, required: true }, { name: 'concentration', type_ref: { tag: 'concrete', type_id: 0x8e02f623d1b2310cn, args: [] }, required: true }, { name: 'margin', type_ref: { tag: 'concrete', type_id: 0x8e02f623d1b2310cn, args: [] }, required: true }, { name: 'revision', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'alternatives', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0x2cdd83694d7a0528n, args: [] }] }, required: true }] } }],
    [0x7e5852e1316d5310n, { id: 0x7e5852e1316d5310n, type_params: [], kind: { tag: 'struct', name: 'TranscribePhoneticWordAlignment', fields: [{ name: 'word_text', type_ref: { tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }, required: true }, { name: 'token_start', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'token_end', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'start_sec', type_ref: { tag: 'concrete', type_id: 0x3f2e589db81e95bfn, args: [] }, required: true }, { name: 'end_sec', type_ref: { tag: 'concrete', type_id: 0x3f2e589db81e95bfn, args: [] }, required: true }, { name: 'zipa_raw_phone_start', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }] }, required: true }, { name: 'zipa_raw_phone_end', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }] }, required: true }, { name: 'zipa_start_sec', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x3f2e589db81e95bfn, args: [] }] }, required: true }, { name: 'zipa_end_sec', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x3f2e589db81e95bfn, args: [] }] }, required: true }, { name: 'transcript_raw', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }] }, required: true }, { name: 'transcript_normalized', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }] }, required: true }, { name: 'zipa_norm_start', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'zipa_norm_end', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'zipa_raw', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }] }, required: true }, { name: 'zipa_normalized', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }] }, required: true }, { name: 'alignment', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0x628e3090bbf58b77n, args: [] }] }, required: true }] } }],
    [0xb1be2fd216bf9a6cn, { id: 0xb1be2fd216bf9a6cn, type_params: [], kind: { tag: 'enum', name: 'TranscribePhoneticAnchorConfidence', variants: [{ name: 'Low', index: 0, payload: { tag: 'unit' } }, { name: 'Medium', index: 1, payload: { tag: 'unit' } }, { name: 'High', index: 2, payload: { tag: 'unit' } }] } }],
    [0x27c28ada137e7ea7n, { id: 0x27c28ada137e7ea7n, type_params: [], kind: { tag: 'enum', name: 'TranscribePhoneticSpanUsefulness', variants: [{ name: 'Low', index: 0, payload: { tag: 'unit' } }, { name: 'Medium', index: 1, payload: { tag: 'unit' } }, { name: 'High', index: 2, payload: { tag: 'unit' } }] } }],
    [0x8cce1c30d22a3da5n, { id: 0x8cce1c30d22a3da5n, type_params: [], kind: { tag: 'enum', name: 'TranscribePhoneticSpanClass', variants: [{ name: 'Repeat', index: 0, payload: { tag: 'unit' } }, { name: 'ShortCodeTerm', index: 1, payload: { tag: 'unit' } }, { name: 'VowelHeavy', index: 2, payload: { tag: 'unit' } }, { name: 'ProperNoun', index: 3, payload: { tag: 'unit' } }, { name: 'FunctionWord', index: 4, payload: { tag: 'unit' } }, { name: 'Ordinary', index: 5, payload: { tag: 'unit' } }] } }],
    ...
    [0x63f2c59fcd7cf12en, { id: 0x63f2c59fcd7cf12en, type_params: [], kind: { tag: 'enum', name: 'RotationCutStrategy', variants: [{ name: 'Uncut', index: 0, payload: { tag: 'unit' } }, { name: 'Qwen3', index: 1, payload: { tag: 'unit' } }, { name: 'Zipa', index: 2, payload: { tag: 'unit' } }, { name: 'ManualTargetCommittedTextTokens', index: 3, payload: { tag: 'newtype', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] } } }] } }],
    [0x019c5f18c69f7358n, { id: 0x019c5f18c69f7358n, type_params: [], kind: { tag: 'struct', name: 'SessionOptions', fields: [{ name: 'chunk_duration', type_ref: { tag: 'concrete', type_id: 0x8e02f623d1b2310cn, args: [] }, required: true }, { name: 'vad_threshold', type_ref: { tag: 'concrete', type_id: 0x8e02f623d1b2310cn, args: [] }, required: true }, { name: 'rollback_tokens', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'commit_token_count', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'max_tokens_streaming', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'max_tokens_final', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'language', type_ref: { tag: 'concrete', type_id: 0x8f4461eb06ae1d0an, args: [] }, required: true }, { name: 'app_id', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }] }, required: true }, { name: 'rotation_cut_strategy', type_ref: { tag: 'concrete', type_id: 0x63f2c59fcd7cf12en, args: [] }, required: true }] } }],
    [0xfadbc0d99baac4a4n, { id: 0xfadbc0d99baac4a4n, type_params: [], kind: { tag: 'struct', name: 'TranscribeWavWithOptionsRequest', fields: [{ name: 'wav_bytes', type_ref: { tag: 'concrete', type_id: 0xba8125876d6388b4n, args: [] }, required: true }, { name: 'options', type_ref: { tag: 'concrete', type_id: 0x019c5f18c69f7358n, args: [] }, required: true }] } }],
    ...
    [0x64fcc0c1da5b4b5fn, { id: 0x64fcc0c1da5b4b5fn, type_params: [], kind: { tag: 'struct', name: 'SessionSnapshot', fields: [{ name: 'revision', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'committed_text', type_ref: { tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }, required: true }, { name: 'pending_text', type_ref: { tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }, required: true }, { name: 'full_text', type_ref: { tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }, required: true }, { name: 'committed_token_count', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'pending_token_count', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'committed_words', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0xb3b757451de582d3n, args: [] }] }, required: true }, { name: 'pending_tokens', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0x0474bae4b8eee308n, args: [] }] }, required: true }, { name: 'ambiguity', type_ref: { tag: 'concrete', type_id: 0x1ab1256ee5bb2ecen, args: [] }, required: true }, { name: 'detected_language', type_ref: { tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }, required: true }] } }],
    ...
    [0x74c5e117239d803an, { id: 0x74c5e117239d803an, type_params: [], kind: { tag: 'struct', name: 'SynthesizePhonemesRequest', fields: [{ name: 'phonemes', type_ref: { tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }, required: true }, { name: 'voice', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }] }, required: true }, { name: 'speed', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x8e02f623d1b2310cn, args: [] }] }, required: true }] } }],
    [0x3399bdacfa32d2ffn, { id: 0x3399bdacfa32d2ffn, type_params: [], kind: { tag: 'struct', name: 'SynthesizePhonemesResult', fields: [{ name: 'wav_bytes', type_ref: { tag: 'concrete', type_id: 0xba8125876d6388b4n, args: [] }, required: true }, { name: 'sample_rate_hz', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'resolved_voice', type_ref: { tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }, required: true }] } }],
    [0x32993f44366d640an, { id: 0x32993f44366d640an, type_params: [], kind: { tag: 'struct', name: 'LoadAudioFileRequest', fields: [{ name: 'path', type_ref: { tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }, required: true }] } }],
    [0x7ca45af8f5b6b9a5n, { id: 0x7ca45af8f5b6b9a5n, type_params: [], kind: { tag: 'struct', name: 'LoadAudioFileResult', fields: [{ name: 'wav_bytes', type_ref: { tag: 'concrete', type_id: 0xba8125876d6388b4n, args: [] }, required: true }] } }],
    ...
    [0xb23f61fe19c815f6n, { id: 0xb23f61fe19c815f6n, type_params: [], kind: { tag: 'struct', name: 'CorpusAlignmentEvalRequest', fields: [{ name: 'limit', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'bucket', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }] }, required: true }, { name: 'randomize', type_ref: { tag: 'concrete', type_id: 0x178367a87f66fb46n, args: [] }, required: true }, { name: 'prompt_id', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }] }, required: true }] } }],
    [0x3b0f6e9188b5c417n, { id: 0x3b0f6e9188b5c417n, type_params: [], kind: { tag: 'enum', name: 'CorpusAlignmentSelectedSpanRole', variants: [{ name: 'BestRescue', index: 0, payload: { tag: 'unit' } }, { name: 'WorstContentful', index: 1, payload: { tag: 'unit' } }, { name: 'WorstRaw', index: 2, payload: { tag: 'unit' } }] } }],
    [0xc5fec80f3af64940n, { id: 0xc5fec80f3af64940n, type_params: [], kind: { tag: 'struct', name: 'CorpusAlignmentEvalRow', fields: [{ name: 'prompt_id', type_ref: { tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }, required: true }, { name: 'ordinal', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'bucket', type_ref: { tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }, required: true }, { name: 'term', type_ref: { tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }, required: true }, { name: 'prompt_text', type_ref: { tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }, required: true }, { name: 'prompt_notes', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }] }, required: true }, { name: 'take', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'wav_path', type_ref: { tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }, required: true }, { name: 'asr_transcript', type_ref: { tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }, required: true }, { name: 'utterance_similarity', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x8e02f623d1b2310cn, args: [] }] }, required: true }, { name: 'utterance_feature_similarity', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x8e02f623d1b2310cn, args: [] }] }, required: true }, { name: 'tail_volatile_token_count', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'row_rescue_ready', type_ref: { tag: 'concrete', type_id: 0x178367a87f66fb46n, args: [] }, required: true }, { name: 'positive_span_count', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'contentful_span_count', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'rescue_eligible_span_count', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'worst_span_feature_similarity', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x8e02f623d1b2310cn, args: [] }] }, required: true }, { name: 'best_span_delta', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x8e02f623d1b2310cn, args: [] }] }, required: true }, { name: 'selected_span_role', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x3b0f6e9188b5c417n, args: [] }] }, required: true }, { name: 'selected_span_text', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }] }, required: true }, { name: 'selected_span_feature_similarity', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x8e02f623d1b2310cn, args: [] }] }, required: true }, { name: 'selected_span_best_delta', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x8e02f623d1b2310cn, args: [] }] }, required: true }, { name: 'trace', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0xf2a49a6e5fbba180n, args: [] }] }, required: true }, { name: 'error', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }] }, required: true }] } }],
    ...
    [0xb804125419e404dan, { id: 0xb804125419e404dan, type_params: [], kind: { tag: 'struct', name: 'CorpusAlignmentEvalJob', fields: [{ name: 'job_id', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'status', type_ref: { tag: 'concrete', type_id: 0xffc78a159481cde0n, args: [] }, required: true }, { name: 'limit', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'bucket', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }] }, required: true }, { name: 'completed_rows', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'total_rows', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'started_at_unix_ms', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'finished_at_unix_ms', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }] }, required: true }, { name: 'result', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x4efa51b1f6a1f95dn, args: [] }] }, required: true }, { name: 'error', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }] }, required: true }] } }],
  ]),
  methods: new Map<bigint, import("@bearcove/vox-core").MethodSendSchemas>([
    ...
    [0x7d68f5c6eee78c18n, { argsRootRef: { tag: 'concrete', type_id: 0x6847ab90feda71c1n, args: [{ tag: 'concrete', type_id: 0xfadbc0d99baac4a4n, args: [] }] }, responseRootRef: { tag: 'concrete', type_id: 0x42046de663beeef0n, args: [{ tag: 'concrete', type_id: 0xaf7f2538613d8b71n, args: [] }, { tag: 'concrete', type_id: 0x4cf4b2aeb98a1939n, args: [{ tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }] }] } }],
    ...
    [0xab5123646f0c3f79n, { argsRootRef: { tag: 'concrete', type_id: 0x6847ab90feda71c1n, args: [{ tag: 'concrete', type_id: 0x74c5e117239d803an, args: [] }] }, responseRootRef: { tag: 'concrete', type_id: 0x42046de663beeef0n, args: [{ tag: 'concrete', type_id: 0x3399bdacfa32d2ffn, args: [] }, { tag: 'concrete', type_id: 0x4cf4b2aeb98a1939n, args: [{ tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }] }] } }],
    [0x8d084b52cc27c60cn, { argsRootRef: { tag: 'concrete', type_id: 0x6847ab90feda71c1n, args: [{ tag: 'concrete', type_id: 0x32993f44366d640an, args: [] }] }, responseRootRef: { tag: 'concrete', type_id: 0x42046de663beeef0n, args: [{ tag: 'concrete', type_id: 0x7ca45af8f5b6b9a5n, args: [] }, { tag: 'concrete', type_id: 0x4cf4b2aeb98a1939n, args: [{ tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }] }] } }],
    ...
    [0x39dcd2b66d7d1384n, { argsRootRef: { tag: 'concrete', type_id: 0x6847ab90feda71c1n, args: [{ tag: 'concrete', type_id: 0xb23f61fe19c815f6n, args: [] }] }, responseRootRef: { tag: 'concrete', type_id: 0x42046de663beeef0n, args: [{ tag: 'concrete', type_id: 0x4efa51b1f6a1f95dn, args: [] }, { tag: 'concrete', type_id: 0x4cf4b2aeb98a1939n, args: [{ tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }] }] } }],
    [0x69aed616d9d95e46n, { argsRootRef: { tag: 'concrete', type_id: 0x6847ab90feda71c1n, args: [{ tag: 'concrete', type_id: 0xb23f61fe19c815f6n, args: [] }] }, responseRootRef: { tag: 'concrete', type_id: 0x42046de663beeef0n, args: [{ tag: 'concrete', type_id: 0xb804125419e404dan, args: [] }, { tag: 'concrete', type_id: 0x4cf4b2aeb98a1939n, args: [{ tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }] }] } }],
...
export const beeMl_synthesizePhonemes_method: MethodDescriptor = {
  name: 'synthesizePhonemes',
  id: 0xab5123646f0c3f79n,
  retry: { persist: false, idem: false },
};

export const beeMl_loadAudioFile_method: MethodDescriptor = {
  name: 'loadAudioFile',
  id: 0x8d084b52cc27c60cn,
  retry: { persist: false, idem: false },
};
...
export const beeMl_descriptor: ServiceDescriptor = {
  ...
  methods: new Map<bigint, MethodDescriptor>([
    ...
    [beeMl_synthesizePhonemes_method.id, beeMl_synthesizePhonemes_method],
    [beeMl_loadAudioFile_method.id, beeMl_loadAudioFile_method],
