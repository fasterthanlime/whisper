...
run_step "Copying libbee_ffi.dylib into app bundle" "mkdir -p /Applications/bee.app/Contents/Frameworks && cp \"$PROJECT_ROOT/target/release/libbee_ffi.dylib\" /Applications/bee.app/Contents/Frameworks/"
