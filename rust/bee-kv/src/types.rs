...
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd)]
pub(crate) struct WordCount(usize);
...
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd)]
pub(crate) struct CharIndex(usize);
...
impl CharIndex {
    ...
    pub(crate) fn saturating_sub(self, other: Self) -> usize {
...
impl CharSpan {
    pub(crate) fn new(start: usize, end: usize) -> Self {
        Self {
            start: CharIndex::new(start),
            end: CharIndex::new(end),
        }
    }
}
...
pub(crate) struct ChunkRun {
    ...
    pub(crate) prompt_tokens: TokenCount,
    /// Number of tokens generated by the model.
    pub(crate) generated_tokens: TokenCount,
    /// Raw generated token IDs (used for KV cache replay).
    pub(crate) generated_token_ids: Vec<TokenId>,
...
pub(crate) struct CarriedBridge {
    ...
    pub(crate) token_ids: Vec<TokenId>,
